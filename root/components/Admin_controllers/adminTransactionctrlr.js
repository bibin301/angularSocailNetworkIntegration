var app = angular.module('routerApp.adminTransactionctrlr', ['toaster']);
app.controller('admintransctrlr', function ($scope, $stateParams, Service, $state, $rootScope, $http, toaster, $modal) {
    $scope.myValue = true;
               ...
               $scope.message = response.data;
                ...
                for (var i = 0; i < overalltranscation.length; i++) {
                    if (overalltranscation[i].fromAddress === $scope.walletaddress) {
                        ...
                        if ($scope.walletaddress === overalltranscation[i].toAddress) {
